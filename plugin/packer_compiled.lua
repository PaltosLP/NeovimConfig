...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/paltos/.local/share/nvim/site/pack/packer/opt/auto-pairs",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/paltos/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["nvim-treesitter"] = {
    loaded = true,
    path = "/home/paltos/.local/share/nvim/site/pack/packer/start/nvim-treesitter",
  ...
  playground = {
    loaded = true,
    path = "/home/paltos/.local/share/nvim/site/pack/packer/start/playground",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'auto-pairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
